SUBROUTINE GB.E.NOF.PO.COLL.LIST.US(Y.RETURN)
*=================================================================================================================================
* Developed by       : Nuren Durdana Abha (FDS)
* Description        : Shows data of same branch Collected PO from CHEQUE.REGISTER.SUPPLEMENT application
* RTN Attached in    : APPLICATION: ENQUIRY, ID: GB.ENQ.ONLN.PO.COLL.LST.US
* Routine Type       : Enquiry
* Standard Selection : NOFILE.PO.COLL.US
* Compilation Time   : 26 DEC, 2024 (14:47)
*=================================================================================================================================
...
*Checking f FT TT INAU records for cleared=========================================================================
...
DATA.FETCH:
    ...
    IF CHQ.REC THEN
        ...
        Y.ISS.BR= CHQ.REC<CQ.ChqSubmit.ChequeRegisterSupplement.CcCrsCoCode>
        ...
        Y.RETURN<-1>= Y.PO.NO:'*':Y.ISS.DT:'*':Y.PAY.TO:'*':Y.ISS.BR:'*':Y.ISS.AMT:'*':Y.ORIGIN.REF:'*':Y.INPUTTER
        !---------------*1*---------*2*-----------*3*----------*4*-----------*5*------------*6*--------------*7*
    END
